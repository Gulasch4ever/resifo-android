...
import at.fh.swengb.resifoAndroid.activities.meldezettelEdit.{Meldezettel01, Meldezettel05a}

/**
  * Created by laszlobalo on 09.01.17.
  */
class PopSwitchActivity05a extends Activity{
  override protected def onCreate(savedInstanceState: Bundle) {
    super.onCreate(savedInstanceState)
    setContentView(R.layout.pop_switch_view_05a)
