...
import at.fh.swengb.resifoAndroid.activities.meldezettelEdit.{Meldezettel01, Meldezettel07}

/**
  * Created by laszlobalo on 09.01.17.
  */
class PopSwitchActivity07 extends Activity{
  override protected def onCreate(savedInstanceState: Bundle) {
    super.onCreate(savedInstanceState)
    setContentView(R.layout.pop_switch_view_07)
