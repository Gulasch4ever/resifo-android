...
import at.fh.swengb.resifoAndroid.activities.meldezettelEdit.{Meldezettel01, Meldezettel03}

/**
  * Created by laszlobalo on 09.01.17.
  */
class PopSwitchActivity03 extends Activity{
  override protected def onCreate(savedInstanceState: Bundle) {
    super.onCreate(savedInstanceState)
    setContentView(R.layout.pop_switch_view_03)
